...
class RaceSponsorsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        //Sponsor1 - A80148364
            ...
            $racesponsor1->insurer_cif = "A80148364";
            $racesponsor1->save();
            //Race2
            $racesponsor2 = new RaceSponsor;
            $racesponsor2->race_id = 2;
            $racesponsor2->insurer_cif = "A80148364";
            $racesponsor2->save();
            //Race3
            $racesponsor3 = new RaceSponsor;
            $racesponsor3->race_id = 3;
            $racesponsor3->insurer_cif = "A80148364";
            $racesponsor3->save();
        ...
        //Sponsor2 - B20820940
            ...
            $racesponsor4->insurer_cif = "B20820940";
            $racesponsor4->save();
            //Race5
            $racesponsor5 = new RaceSponsor;
            $racesponsor5->race_id = 4;
            $racesponsor5->insurer_cif = "B20820940";
            $racesponsor5->save();
            //Race6
            $racesponsor6 = new RaceSponsor;
            $racesponsor6->race_id = 6;
            $racesponsor6->insurer_cif = "B20820940";
            $racesponsor6->save();
        ...
        //Sponsor3 - B65091076
            ...
            $racesponsor7->insurer_cif = "B65091076";
            $racesponsor7->save();
            //Race8
            $racesponsor8 = new RaceSponsor;
            $racesponsor8->race_id = 5;
            $racesponsor8->insurer_cif = "B65091076";
            $racesponsor8->save();
        ...
        //Sponsor4 - B66110644
            ...
            $racesponsor9->insurer_cif = "B66110644";
            $racesponsor9->save();
            //Race10
            $racesponsor10 = new RaceSponsor;
            $racesponsor10->race_id = 1;
            $racesponsor10->insurer_cif = "B66110644";
            $racesponsor10->save();
        ...
        //Sponsor5 - B83916056
            ...
            $racesponsor11->insurer_cif = "B83916056";
            $racesponsor11->save();
            //Race12
            $racesponsor12 = new RaceSponsor;
            $racesponsor12->race_id = 4;
            $racesponsor12->insurer_cif = "B83916056";
            $racesponsor12->save();
        ...
        //Sponsor6 - F-189561265
            ...
            $racesponsor13->insurer_cif = "F-189561265";
            $racesponsor13->save();
            //Race14
            $racesponsor14 = new RaceSponsor;
            $racesponsor14->race_id = 6;
            $racesponsor14->insurer_cif = "F-189561265";
            $racesponsor14->save();
        ...
        //Sponsor7 - N0393770C
            ...
            $racesponsor15->insurer_cif = "N0393770C";
            $racesponsor15->save();
            //Race16
            $racesponsor16 = new RaceSponsor;
            $racesponsor16->race_id = 5;
            $racesponsor16->insurer_cif = "N0393770C";
            $racesponsor16->save();
            //Race17
            $racesponsor17 = new RaceSponsor;
            $racesponsor17->race_id = 4;
            $racesponsor17->insurer_cif = "N0393770C";
            $racesponsor17->save();
